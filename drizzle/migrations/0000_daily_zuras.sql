CREATE TYPE "public"."user_role" AS ENUM('rep', 'admin', 'super_admin');--> statement-breakpoint
...
CREATE UNIQUE INDEX "users_org_id_email_idx" ON "users" USING btree ("org_id","email");